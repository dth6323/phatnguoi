...
class ViolationsResourceIT {
    ...
    private static final LocalDate DEFAULT_VIOLATION_TIME = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_VIOLATION_TIME = LocalDate.now(ZoneId.systemDefault());

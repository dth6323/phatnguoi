...
public class TypeViolationResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TypeViolation>> getAllTypeViolations(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of TypeViolations");
        Page<TypeViolation> page = typeViolationRepository.findAll(pageable);

...
public class VehicleRegistrationsResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<VehicleRegistrations>> getAllVehicleRegistrations(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        LOG.debug("REST request to get a page of VehicleRegistrations");
        Page<VehicleRegistrations> page = vehicleRegistrationsRepository.findAll(pageable);
    ...
    public ResponseEntity<VehicleRegistrations> getVehicleRegistrations(@PathVariable("id") Long id) {
        ...
        Optional<VehicleRegistrations> vehicleRegistrations = vehicleRegistrationsRepository.findById(id);

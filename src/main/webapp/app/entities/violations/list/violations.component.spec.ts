...
describe('Violations Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ViolationsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.violations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to violationsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getViolationsIdentifier');
      const id = comp.trackId(entity);
      expect(service.getViolationsIdentifier).toHaveBeenCalledWith(entity);

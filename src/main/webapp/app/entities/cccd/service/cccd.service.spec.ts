...
const requireRestSample: RestCCCD = {
  ...
  dateBirth: sampleWithRequiredData.dateBirth?.format(DATE_FORMAT),
  dateIssue: sampleWithRequiredData.dateIssue?.format(DATE_FORMAT),
  dateExpiry: sampleWithRequiredData.dateExpiry?.format(DATE_FORMAT),
};
